...
--
-- Host: localhost    Database: travel_list
-- ------------------------------------------------------
...
CREATE TABLE `catg` (
  ...
  `catg_desc` varchar(100) DEFAULT NULL,
...
INSERT INTO `catg` VALUES (3,'Tour Packages','Vacation and adventure trips',700.00),(5,'Car Rentals','Vehicle Travelling',500.00);
...
-- Dump completed on 2025-04-02 16:20:52
